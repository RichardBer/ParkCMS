	    ...
	    <asp:DataGrid id="grdLocals" Width="100%" BorderStyle="None" GridLines="None" BorderWidth="0px" runat="server" AutoGenerateColumns="False">
		  <Columns>
			...
			<asp:TemplateColumn HeaderText="Original Resource">
			  ...
			  <ItemStyle HorizontalAlign="Center" CssClass="post"></ItemStyle>
			  <ItemTemplate>
			    <asp:TextBox id="txtResource" runat="server" Text='<%# Eval("ResourceValue") %>' Height="30px" Enabled="false">
                </asp:TextBox>
			  </ItemTemplate>
			</asp:TemplateColumn>
		    <asp:TemplateColumn HeaderText="Localized Resource">
			  ...
			  <ItemTemplate>
			    <asp:TextBox id="txtLocalized" runat="server" Text='<%# Eval("LocalizedValue") %>' Height="30px" ToolTip='<%# Eval("ResourceValue") %>'>
                </asp:TextBox>
